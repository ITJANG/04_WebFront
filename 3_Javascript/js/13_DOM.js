...
document.querySelector("#btn1").addEventListener("click", () => {
  ...
  // -> list[11]의 마지막 자식으로 "ZZZ" 라는 TesxtNode 추가

  list[11].appendChild( document.createTextNode("ZZZ") );

  // 2. 마지막 자식으로 추가( append("내용" or 노드 or 요소 n개) )
  list[11].append("ZZZ");
  list[11].append("12345", "abcd", "가나다라")

  // 3. 첫 번째 자식으로 추가 ( 요소.prepend("내용" or 노드 or 요소n개) )
  list[11].prepend("오늘", "점심", "뭐먹지?");

  // 4. 이전/다음 형제로 추가 (요소.before("내용" or 노드 or 요소n개) / 요소 after("내용" or 노드 or 요소n개))
